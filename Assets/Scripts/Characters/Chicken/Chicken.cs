...
namespace Characters.Chicken
{
    public abstract class Chicken : MonoBehaviour, IVisualDetectable, ITrappable
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            Gizmos.DrawWireSphere(foot.position, stats.FootRadius);
            Gizmos.DrawLine(foot.position , slope.point);
            Gizmos.DrawWireSphere(slope.point, stats.FootRadius);
        }
